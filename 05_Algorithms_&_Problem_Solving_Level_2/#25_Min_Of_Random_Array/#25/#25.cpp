// Write a program to fill an array with max size 100 with random numbers from 1 to 100 then print Min.
// Example Input
...
int MinNumbInArray(int arr[], int length)
{
	int min = arr[0];
	for (int i = 0; i < length; i++)
	{
...
int main()
{
	...
	cout << "Minimium Number is: ";
	cout << MinNumbInArray(arr, arrayLength) << endl;
	return 0;
}