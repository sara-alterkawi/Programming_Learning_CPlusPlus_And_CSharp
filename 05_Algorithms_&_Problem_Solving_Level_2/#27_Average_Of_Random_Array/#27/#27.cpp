// Write a program to fill an array with max size 100 with random numbers from 1 to 100 then print average of all numbers.
// Example Input
// Enter number of elements: 10
// Output
// Array Elements: 42 68 35 1 70 25 79 59 63 65
// Average of all Numbers is : 43
...
{
	return SumAllNumbInArray(arr, length) / length;
}
...
int main()
{
	...
	cout << AverageOfArray(arr, arrayLength) << endl;
	return 0;
}