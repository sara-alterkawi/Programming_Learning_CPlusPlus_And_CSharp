...
//
int FindNumberPositionInArray(int arr[100], int arrayLength, int numb)
{
...
void PrintSearchResult(int position, int number)
{
	...
	{
		cout << "The number found at position (index): " << position << endl;
...
int main()
{
	...
	cout << "Number you are looking for is: " << numb << endl;
